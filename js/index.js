//立即执行函数，防止变量污染，减少命名冲突，里面的变量都是局部变量
        ...
        series: [
          {
            ...
            itemStyle:{
                barBorderRadius:20,
                //修改柱子颜色，params传进来的是柱子对象，dataIndex当前柱子索引号
    ...
    series: [
      {
        name: '年龄分布',
        type: 'pie',
        radius: ['40%', '60%'], //第一个值是内圆的半径，第二个值是外圆半径
        center:["50%","45%"],
...
var XNData = [
    ...
    [{name:'西宁'}, {name:'日照',value:100}],
    [{name:'西宁'}, {name:'银川',value:100}]
];

var YCData = [
    [{name:'拉萨'}, {name:'武汉',value:100}],
    [{name:'武汉'}, {name:'苏州',value:100}],
